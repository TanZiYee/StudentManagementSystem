...
<center><h1>Student Management System</h1></center>
  ...
  <form class="form-horizontal" method="post">
    ...
    <div class ="form-group">
        ...
        <div class="col-md-10">
        <div class="ïnput-group">
            <span class="ïnput-group-addon"><i class="fa fa-key fa" aria hidden="true"></i></span>
            
            <input type="confirm-password" class="form-control" id="confirm-pwd" name="confirm-pwd" placeholder="Enter password again">
        </div>
        </div>
    </div>
    ...
    <div class="form-group">        
      ...
      <button type="hidden"  class="btn btn-warning"><a href="index_test.php">Register</button>
